      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.sectionText}>
            Welcome to SBP Travels, where we create memorable travel experiences. Our mission is to provide exceptional service and unforgettable journeys.
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.sectionText}>
            At SBP Travels, we offer a variety of travel packages including adventure treks, cultural tours, and customized itineraries to meet your needs.
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.sectionText}>
            "SBP Travels made our trip unforgettable! Highly recommended." - Judith Muli
          </Text>
        </View>
